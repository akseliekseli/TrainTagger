...
CLASS_LABEL_STYLE = {
    ...
    "H_qq": "$H_{qq}$",
    "H_ss": "$H_{ss}$",
    "H_tauhtaue": "$H_{\\tau_h\\tau_e}$",
    "H_tauhtauh": "$H_{\\tau_h\\tau_h}$",
    "H_tauhtaum": "$H_{\\tau_h\\tau_\\mu}$",
    "Hext_aa": "$H_{\\gamma\\gamma}^{ext}$",
    ...
    "Top_Wmv": "$t_{W\\mu\\nu}$",
    "Top_Wqq": "$t_{Wqq}$",
    "Top_Wtauev": "$t_{W\\tau_e\\nu}$",
    "Top_Wtauhv": "$t_{W\\tau_h\\nu}$",
    "Top_Wtaumv": "$t_{W\\tau_\\mu\\nu}$",
    "Top_bWc": "$t_{bWc}$",
    "Top_bWcs": "$t_{bWcs}$",
    "Top_bWev": "$t_{bWe\\nu}$",
    "Top_bWmv": "$t_{bW\\mu\\nu}$",
